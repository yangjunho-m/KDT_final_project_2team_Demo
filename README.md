...
프로젝트의 기획 배경, 데이터 수집, 모델 분석, 시스템 구조 및 구현 결과는 아래 발표 자료에서 확인할 수 있습니다.

### [📄 최종 발표 PDF 열기](./docs/final-presentation.pdf)
...
- FastAPI API 문서  
  http://140.245.92.139:8000/docs

- MinIO 관리 화면  
  http://140.245.92.139:9001/login

> 배포 서버는 데모 운영 상황에 따라 접속이 제한될 수 있습니다.
...
**KDT 2026 Acorn 7기 2팀 · 청신호팀**

| 이름 | 담당 |
|---|---|
| 조주영 | 프로젝트 총괄, 데이터 구축, 모델 검증 |
| 김민주 | 프로젝트 기획, 데이터 구축, 모델 검증 |
| 김현규 | 데이터 분석, 실험지역 선정, 품질 검증 |
| 박서하 | 드론뷰 데이터 수집, 모델 및 증강 실험 |
| 양준호 | 백엔드 시스템 구축, 모델 분석, 데이터 수집 |
| 정윤아 | 일정 관리, 문서화, 발표 자료 |
| 최보성 | AI 모델 검토, 프론트엔드·백엔드 및 UI/UX |
...
- 배포 서버는 데모 운영 상황에 따라 접속이 제한될 수 있습니다.
- 서버 접속이 불가능한 경우 로컬 실행 방법을 이용해 주세요.
- 환경변수, 비밀번호, API 키 및 서버 인증정보는 저장소에 커밋하지 않습니다.
- MinIO 계정 정보는 README 또는 소스코드에 공개하지 않습니다.
