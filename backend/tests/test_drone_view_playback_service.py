...
def test_route_preview_position_uses_true_actual_position() -> None:
    actual_position = {
        "latitude": 37.5541811,
...
def test_route_preview_position_falls_back_when_true_position_is_missing() -> None:
    display_position = {
        "latitude": 37.5541811,
        "longitude": 126.9209826,
        "altitude": 120.0,
...
def test_jamming_correction_uses_crossview_instead_of_precomputed_correction() -> None:
...
def test_jamming_correction_falls_back_when_crossview_is_missing() -> None:
    position = _position_from_row(
        {
            "altitude_agl_m": "120",
            "jamming_corrected_latitude_deg": "37.1",
